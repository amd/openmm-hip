#ifndef __OPENMM_HIPFFTIMPLFFT3D_H__
#define __OPENMM_HIPFFTIMPLFFT3D_H__
...
class OPENMM_EXPORT_COMMON HipFFTImplFFT3D : public HipFFTBase {
public:
    /**
     * Create an HipFFTImplFFT3D object for performing transforms of a particular size.
     *
     ...
     */
    HipFFTImplFFT3D(HipContext& context, int xsize, int ysize, int zsize, bool realToComplex, hipStream_t stream, HipArray& in, HipArray& out);
    virtual ~HipFFTImplFFT3D();
    /**
...
#endif // __OPENMM_HIPFFTIMPLFFT3D_H__
